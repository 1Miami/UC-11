...
private void ComboxSelecionarDoencaActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void initComponents() {
        ...
        ExcluirDoencaBTN = new javax.swing.JButton();
        ...
        ExcluirDoencaBTN.setText("Excluir");
        ExcluirDoencaBTN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ExcluirDoencaBTNActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(32, 32, 32)
                .addComponent(ExcluirDoencaBTN, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ExcluirDoencaBTN, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
...
private void limparCampos() {
    txtfieldmudarnomedoenca.setText("");
    txtfieldmudarsintomas.setText("");
    txtfieldmudartratamento1.setText("");
    txtfieldmudarsobre.setText("");
    SeforPicada.setSelected(false);
    ComboxSelecionarDoenca.setSelectedIndex(-1);
}
    ...
    private void ExcluirDoencaBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExcluirDoencaBTNActionPerformed
         String nomeDoencaSelecionada = (String) ComboxSelecionarDoenca.getSelectedItem();
    if (nomeDoencaSelecionada != null) {
        int resposta = JOptionPane.showConfirmDialog(this, "Tem certeza de que deseja excluir esta doença?", "Confirmação de Exclusão", JOptionPane.YES_NO_OPTION);
        if (resposta == JOptionPane.YES_OPTION) {
            try {
                doencaManager.excluirDoenca(nomeDoencaSelecionada);
                carregarDoencas(); // Atualiza a lista na GUI
                limparCampos(); // Limpa os campos após exclusão
                JOptionPane.showMessageDialog(this, "Doença excluída com sucesso!");
            } catch (RuntimeException ex) {
                Logger.getLogger(EditarD.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "Erro ao excluir a doença.");
            }
        }
    } else {
        JOptionPane.showMessageDialog(this, "Nenhuma doença selecionada para exclusão.");   
    }    
    }//GEN-LAST:event_ExcluirDoencaBTNActionPerformed
    ...
    private javax.swing.JButton ExcluirDoencaBTN;
